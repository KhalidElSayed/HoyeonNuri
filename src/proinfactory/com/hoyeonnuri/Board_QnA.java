...
public class Board_QnA extends Activity implements OnItemClickListener {
	...
	private String site_URL = "http://dormitel.korea.ac.kr/pub/board/bbs_free.html?cboardID=part060201&page=";
	private View footer;
	...
	private final Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			if(msg.what==1) {
				Intent intent = new Intent(Board_QnA.this, Board_Notice.class);
				startActivity(intent);
				Toast.makeText(Board_QnA.this, "로그인이 필요합니다.", Toast.LENGTH_LONG).show();
				finish();
				return;
			}
			listUpdate();
		...
		public void onClick(View v) {
			...
			case R.id.board_navi_selector:
				...
				ArrayAdapter<String> arrayAdt = new ArrayAdapter<String>(
						Board_QnA.this, android.R.layout.select_dialog_item,
						arrStr);
				selectorDialog.setAdapter(arrayAdt, new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int which) {
						Intent intent;
						switch(which) {
						case 0:
							intent= new Intent(Board_QnA.this, Board_Notice.class);
							startActivity(intent);
							finish();
							break;
						case 1:
							intent= new Intent(Board_QnA.this, Board_Free.class);
							startActivity(intent);
							finish();
							break;
						case 2:
							intent= new Intent(Board_QnA.this, Board_Repair.class);
							startActivity(intent);
							finish();
							break;
						}
			...
			case R.id.board_navi_settingbtn:
				Intent intent = new Intent(Board_QnA.this,Setting.class);
				startActivity(intent);
				break;
			}
		}
