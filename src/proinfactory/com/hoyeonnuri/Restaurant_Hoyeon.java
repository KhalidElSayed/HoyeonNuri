...
public class Restaurant_Hoyeon extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (tmp.indexOf("ab") != -1) {
			site_url = tmp.substring(tmp.indexOf("<bb>") + 4,
					tmp.indexOf("</bb>"));
			site_url2 = tmp.substring(tmp.indexOf("<bc>") + 4,
					tmp.indexOf("</bc>"));
		}
	...
	private View.OnClickListener mOnClick = new View.OnClickListener() {
		...
		public void onClick(View v) {
				...
				selectorDialog.setAdapter(arrayAdt,
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								switch (which) {
								case 0:
									intent = new Intent(Restaurant_Hoyeon.this,
			...
			case R.id.res_navi_settingbtn:
				Intent intent = new Intent(Restaurant_Hoyeon.this, Setting.class);
				startActivity(intent);
				break;
			}
		}
