...
public class Board_Repair extends Activity implements OnItemClickListener {
	...
	private String site_URL = "http://dormitel.korea.ac.kr/pub/board/bbs_free.html?cboardID=part060101&page=";
	private View footer;
	...
	private final Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			if (msg.what == 1) {
				Intent intent = new Intent(Board_Repair.this,
						Board_Notice.class);
				startActivity(intent);
				Toast.makeText(Board_Repair.this, "로그인이 필요합니다.",
		...
		public void onClick(View v) {
			...
			case R.id.board_navi_selector:
				...
				ArrayAdapter<String> arrayAdt = new ArrayAdapter<String>(
						Board_Repair.this, android.R.layout.select_dialog_item,
						arrStr);
				selectorDialog.setAdapter(arrayAdt,
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								switch (which) {
								case 0:
									intent = new Intent(Board_Repair.this,
											Board_Notice.class);
									startActivity(intent);
									finish();
									break;
			...
			case R.id.board_navi_settingbtn:
				Intent intent = new Intent(Board_Repair.this, Setting.class);
				startActivity(intent);
				break;
			}
		}
