...
public class Restaurant_3 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (tmp.indexOf("ab") != -1) {
			site_url = tmp.substring(tmp.indexOf("<cb>") + 4,
					tmp.indexOf("</cb>"));
			site_url2 = tmp.substring(tmp.indexOf("<cc>") + 4,
					tmp.indexOf("</cc>"));
		}
	...
	private View.OnClickListener mOnClick = new View.OnClickListener() {
		...
		public void onClick(View v) {
				...
				selectorDialog.setAdapter(arrayAdt,
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								switch (which) {
								case 0:
									intent = new Intent(Restaurant_3.this,
			...
			case R.id.res_navi_settingbtn:
				Intent intent = new Intent(Restaurant_3.this, Setting.class);
				startActivity(intent);
				break;
			}
		}
